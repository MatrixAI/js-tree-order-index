  ...
  insertChild (
    ...
    const [[
      ...
      (
        ...
        // we have insertIntoNode
        // and insertIntoLeafPair
        // and insertIntoLeaf
        // here we will always use insertIntoLeafPair
        // since we know what it is
        // we want to know the position we want to insert into


        // so if we have a cursor
        // we know that if position is positive
        // we want to iterate to the correct position
        // in this case we want to iterate until there either the position finishes
        // or whatever



        // so we use the linkOpen for when we are positive position
        // and we use the linkClose for when we are in negative position

        // we have to use our cursors
        // and make sure to be able to jump to siblings
        // so let's add that to our cursor impl

        // ok so now we can navigate between systems
        // so we should acquire a cursor
