...
class BOITree<data: *> implements OrderIndexI<LinkOpen, LinkClose, Cursor, data> {
  ...
  clone (
    parameters: Object
  ): OrderIndexI<LinkOpen, LinkClose, Cursor, data> {
    return new BOITree({
  ...
  insertRoot (
    ...
    const [[
      ...
      const updateLink = (id, openLinkUpdated, closeLinkUpdated) => {
        ...
        // what do you mean property not found?
        // nodeTableT is not a map
