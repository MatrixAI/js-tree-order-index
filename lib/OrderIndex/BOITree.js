  ...
  insertRoot (
    ...
    const [[
      ...
      (
        ...
        // the problem is that nestContexts assuems
        // that context is one type
        // but actually we have multiple contexts
        // so we should really say that context can be any
        ...
        if (
          ...
          // this is treeTableT has, it's the method that it supports
          // it doesn't know that treeTableT is MapI and supports all those capabilities
