  ...
  insertRoot (
    ...
    const [[
      ...
      if (
        ...
        // here is the updateLink
        const updateLink = (id, openLinkUpdated, closeLinkUpdated) => {
          if (!openLink && !closeLink) return;

          console.log('updating links');
          console.log('id', id); // this is null for some reason
          console.log('openLink', openLink);
          console.log('closeLink', closeLink);


          // wait this doesn't work
          // this has to update the link
          // but we can't be updating the link
          // OH YEA
          // these are the links here
