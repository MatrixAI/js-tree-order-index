...
class Leaf {
  ...
  splitI (idNew: TreeId, index?: number): [Leaf, Leaf] {
    ...
    // we need to updateLink to childrenLeft and childrenRight
    ...
    const [[
      ...
      if (this._leftId === this._rightId === this._rootId) {
        ...
        if (block.space >= 2) {
          ...
          // create the new root
          const children = [blockLeft, blockRight];
        ...
        this._insertEntry(blockLeft, 0, entryOpen);
        this._insertEntry(blockRight, -1, entryClose);
