...
// we shall use this one instead, as is is an open type
// this allows us to use this as the minimal set of data that must exist
// new data can then be entered in the future if necessary
type Node<linkOpen: Object, linkClose: Object, data: Object> =
  { id: NodeId, level: NodeLevel } &
  linkOpen &
  linkClose &
