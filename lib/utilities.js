...
// gapkey generation
// either you get the half way point between 2
// or you generate your next number based on the position
// remember if you are the first
// you just get the first gap
// if you are the second, you're now in between the first and the largest number
// then you need to add the designated gapsize to the first number
// as long as it is within the number scheme
// if it is not if iti snot you always leve a gap
// and you add in what ever you can?
