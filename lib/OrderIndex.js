...
// ok so what we are saying is that the order index does know the data type
// how do we make sure we know these are the same things?

interface OrderIndexI<linkOpen, linkClose, cursor, data> {
